  ...
  Future<void> _displayPickImageDialog(
    ...
    return showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: const Text('Parametreler girin'),
            content: Column(
              ...
              children: <Widget>[
                TextField(
                  ...
                  decoration: const InputDecoration(
                      hintText: 'Maksimum genişlik girin'),
                ),
                TextField(
                  ...
                  keyboardType:
                      const TextInputType.numberWithOptions(decimal: true),
                  decoration: const InputDecoration(
                      hintText: 'Maksimum yükseklik girin'),
                ),
                TextField(
                  controller: qualityController,
                  keyboardType: TextInputType.number,
                  decoration: const InputDecoration(hintText: 'Kalite girin'),
                ),
                if (isMulti)
                  TextField(
                    ...
                    keyboardType: TextInputType.number,
                    decoration:
                        const InputDecoration(hintText: 'Görsel limiti girin'),
                  ),
              ],
            ),
            actions: <Widget>[
